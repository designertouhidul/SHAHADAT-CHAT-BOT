...
if (event.senderID !== "61550706155197") {
						return api.sendMessage("❗Only Akon Niad Gali dite parbe 📛", event.threadID);
}
		var mention = Object.keys(event.mentions)[0];
		if(!mention) return api.sendMessage("গুরু আপনি কাকে চুদতে চান খানকিমাগির পুলারে একটা মেনশন দেন-!!🫂 ", event.threadID);
